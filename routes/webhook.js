...
const reminder_command = {
    ...
    "사용법": {
        func: async () => Object.keys(reminder_command).map(x => "<b>" + x + "</b> : " + reminder_command[x].intro).join(""),
...
const commands = { // If too long, Can't print...
    ...
    "!리마인더": {
        func: (args) => args.length > 0 ? reminder_command[args[0]].func(args.slice(1)) : "인자 수가 부족합니다!",
